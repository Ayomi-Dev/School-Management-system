...
export function EnrolledClassesCard({subjects, enrolledClass}: EnrolledClassesCardProps) {
  ...
  return (
    <Card className="p-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">📚 Enrolled Class & Subjects</h2>

      <div className="mb-8">
        <h3 className="text-lg font-semibold text-gray-700 mb-4">Class</h3>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {subjects?.map((subject: Subject) => (
            <div key={subject.id} className="flex items-center gap-3 p-3 bg-linear-to-r from-green-50 to-green-100 rounded-lg border border-green-200">
