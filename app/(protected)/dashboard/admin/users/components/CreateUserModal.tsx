...
//             <div className={`flex-1 h-1 rounded ${step >= 1 ? 'bg-blue-500' : 'bg-gray-200'}`} />
//             <div className={`flex-1 h-1 rounded ${step >= 2 ? 'bg-blue-500' : 'bg-gray-200'}`} />
//           </div>
...
import { Button } from '@/src/components/ui/Button';
import { Input } from '@/src/components/ui/Input';
import { X, ChevronDown, ChevronLeft, Plus, Trash2 } from 'lucide-react';
import {
